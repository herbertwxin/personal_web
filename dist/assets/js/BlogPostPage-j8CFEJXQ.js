import{j as e,r as g}from"./vendor-react-DQfWul--.js";import{B as d}from"./button-Q_8ATq9D.js";import{B as k}from"./badge-its26Hhq.js";import{a as w,b as T,C as L,T as A,c as S,d as j}from"./vendor-icons-Diy5OvQ5.js";import{m as x}from"./vendor-motion-DK5xT7Nv.js";import"./vendor-misc-bxjwWExe.js";import"./ui-core-pWqjCSTO.js";import"./ui-misc-_JMWmYUQ.js";import"./vendor-react-remove-scroll-Be5tUvnv.js";import"./vendor-react-remove-scroll-bar-CT6XHitq.js";import"./vendor-react-style-singleton-D7expayH.js";import"./vendor-use-callback-ref-C_ANbdkC.js";import"./utils-styling-CfDMlrKu.js";import"./index-CGnTCQpd.js";import"./vendor--vercel-CuPUoM8P.js";function N({content:f}){const m=l=>{var r;const n=l.split(`
`),o=[];let a=0;for(;a<n.length;){const t=n[a];if(t.startsWith("```")){const s=t.substring(3).trim(),i=[];for(a++;a<n.length&&!n[a].startsWith("```");)i.push(n[a]),a++;a++;let h=i.join(`
`),c=s;!c&&h.includes("[Desktop Entry]")&&(c="desktop");const u=h.split(`
`);if(u.length>0){const y=((r=u[0].match(/^[\t\s]*/))==null?void 0:r[0])||"";y&&u.every(p=>p.startsWith(y)||p.trim()==="")&&(h=u.map(p=>p.substring(y.length)).join(`
`))}let b="text-gray-100";c==="bash"?b="text-purple-400":c==="desktop"&&(b="text-blue-300"),o.push(e.jsx("div",{className:"my-4",children:e.jsxs("div",{className:"bg-gray-900 rounded-lg overflow-hidden",children:[(s||c)&&e.jsx("div",{className:"bg-gray-800 px-4 py-2 text-sm text-gray-300 font-mono border-b border-gray-700",children:s||c}),e.jsx("pre",{className:"p-4 overflow-x-auto",children:e.jsx("code",{className:`text-sm font-mono ${b}`,children:h})})]})},`code-${a}`));continue}const v=t.replace(/`([^`]+)`/g,'<code class="bg-gray-100 px-1 py-0.5 rounded text-sm font-mono text-gray-800">$1</code>');if(t.startsWith("# "))o.push(e.jsx("h1",{className:"text-3xl font-bold mt-8 mb-4 text-black",children:t.substring(2)},a));else if(t.startsWith("## "))o.push(e.jsx("h2",{className:"text-2xl font-semibold mt-6 mb-3 text-black",children:t.substring(3)},a));else if(t.startsWith("### "))o.push(e.jsx("h3",{className:"text-xl font-medium mt-4 mb-2 text-black",children:t.substring(4)},a));else if(t.startsWith("#### "))o.push(e.jsx("h4",{className:"text-lg font-medium mt-3 mb-2 text-black",children:t.substring(5)},a));else if(t.trim()==="")o.push(e.jsx("br",{},a));else if(t.includes("=")&&(t.includes("_")||t.includes("^")||t.includes("∑")||t.includes("∫")))o.push(e.jsx("div",{className:"bg-gray-50 p-3 my-2 rounded border-l-4 border-blue-200 font-mono text-sm",children:t},a));else if(t.trim().startsWith("- "))o.push(e.jsx("li",{className:"ml-4 mb-1 text-gray-700",children:t.substring(t.indexOf("- ")+2)},a));else if(/^\d+\./.test(t.trim()))o.push(e.jsx("li",{className:"ml-4 mb-1 text-gray-700 list-decimal",children:t.substring(t.indexOf(".")+1).trim()},a));else{const s=v.replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>");o.push(e.jsx("p",{className:"mb-3 text-gray-700 leading-relaxed",dangerouslySetInnerHTML:{__html:s}},a))}a++}return o};return e.jsx("div",{className:"prose prose-lg max-w-none",children:m(f)})}function P({blogId:f,onBack:m}){const[l,n]=g.useState(!1),[o,a]=g.useState(!1),[r,t]=g.useState(!1);g.useEffect(()=>{const i=setTimeout(()=>n(!0),100);return()=>clearTimeout(i)},[]);const s=[{id:1,title:"Kornai (1979) Framework on Autocratic Governance",excerpt:"A comment on Kornai (1979) where I found similarities between socialist firms and autocratic local governments",date:"2024-02-05",readTime:"6 min read",tags:["Political Economy","Governance","Theory"],featured:!0,content:`## Introduction
...
This would allow LaTeX Workshop to communicate with LaTeX.`}].find(i=>i.id===f);return s?e.jsx("div",{className:"min-h-screen pb-12",children:e.jsxs("div",{className:"max-w-4xl mx-auto px-6",children:[e.jsxs(x.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.6},className:"py-8",children:[e.jsxs(d,{variant:"ghost",onClick:m,className:"mb-8 text-black hover:bg-gray-100",children:[e.jsx(w,{className:"w-4 h-4 mr-2"}),"Back to Blog"]}),e.jsxs("header",{className:"mb-8",children:[e.jsx("h1",{className:"text-black mb-6",style:{fontSize:"var(--academic-font-size-page-title)",fontWeight:"var(--academic-font-weight-page-title)",lineHeight:"var(--academic-line-height-tight)"},children:s.title}),e.jsxs("div",{className:"flex flex-wrap items-center gap-6 mb-6",children:[e.jsxs("div",{className:"flex items-center gap-2 text-gray-600",children:[e.jsx(T,{className:"w-4 h-4"}),e.jsx("span",{style:{fontSize:"var(--academic-font-size-metadata)"},children:new Date(s.date).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})})]}),e.jsxs("div",{className:"flex items-center gap-2 text-gray-600",children:[e.jsx(L,{className:"w-4 h-4"}),e.jsx("span",{style:{fontSize:"var(--academic-font-size-metadata)"},children:s.readTime})]})]}),e.jsx("div",{className:"flex flex-wrap gap-2 mb-8",children:s.tags.map(i=>e.jsx(k,{variant:"secondary",className:"bg-gray-100 text-gray-700 hover:bg-gray-200",children:i},i))})]})]}),e.jsx(x.article,{initial:{opacity:0,y:20},animate:{opacity:l?1:0,y:l?0:20},transition:{duration:.6,delay:.2},className:"prose prose-lg max-w-none",style:{fontSize:"var(--academic-font-size-body)",lineHeight:"var(--academic-line-height-normal)",color:"var(--academic-text-primary)"},children:e.jsx(N,{content:s.content})}),e.jsx(x.div,{initial:{opacity:0,y:20},animate:{opacity:l?1:0,y:l?0:20},transition:{duration:.6,delay:.4},className:"mt-12 pt-8 border-t border-gray-200",children:e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsxs(d,{variant:"outline",size:"sm",onClick:()=>a(!o),className:`${o?"bg-blue-50 text-blue-600 border-blue-200":""}`,children:[e.jsx(A,{className:`w-4 h-4 mr-2 ${o?"fill-current":""}`}),o?"Liked":"Like"]}),e.jsxs(d,{variant:"outline",size:"sm",onClick:()=>t(!r),className:`${r?"bg-yellow-50 text-yellow-600 border-yellow-200":""}`,children:[e.jsx(S,{className:`w-4 h-4 mr-2 ${r?"fill-current":""}`}),r?"Saved":"Save"]})]}),e.jsxs(d,{variant:"outline",size:"sm",children:[e.jsx(j,{className:"w-4 h-4 mr-2"}),"Share"]})]})})]})}):e.jsx("div",{className:"min-h-screen flex items-center justify-center",children:e.jsxs("div",{className:"text-center",children:[e.jsx("h1",{className:"text-2xl font-bold mb-4",children:"Post not found"}),e.jsxs(d,{onClick:m,children:[e.jsx(w,{className:"w-4 h-4 mr-2"}),"Back to Blog"]})]})})}export{P as BlogPostPage};
