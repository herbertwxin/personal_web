import{j as e,r as c}from"./vendor-react-DQfWul--.js";import{B as n}from"./button-CnlRQ0da.js";import{B as f}from"./badge-DL_Sfjde.js";import{a as u,b,C as g,T as y,c as x,d as v}from"./vendor-icons-Diy5OvQ5.js";import{m as h}from"./vendor-motion-DK5xT7Nv.js";import"./vendor-misc-bxjwWExe.js";import"./ui-core-pWqjCSTO.js";import"./ui-misc-_JMWmYUQ.js";import"./vendor-react-remove-scroll-Be5tUvnv.js";import"./vendor-react-remove-scroll-bar-CT6XHitq.js";import"./vendor-react-style-singleton-D7expayH.js";import"./vendor-use-callback-ref-C_ANbdkC.js";import"./utils-styling-CfDMlrKu.js";import"./index-CAxZ34SS.js";import"./vendor--vercel-CuPUoM8P.js";function w({content:d}){const r=o=>o.split(`
`).map((t,a)=>{if(t.startsWith("# "))return e.jsx("h1",{className:"text-3xl font-bold mt-8 mb-4 text-black",children:t.substring(2)},a);if(t.startsWith("## "))return e.jsx("h2",{className:"text-2xl font-semibold mt-6 mb-3 text-black",children:t.substring(3)},a);if(t.startsWith("### "))return e.jsx("h3",{className:"text-xl font-medium mt-4 mb-2 text-black",children:t.substring(4)},a);if(t.startsWith("#### "))return e.jsx("h4",{className:"text-lg font-medium mt-3 mb-2 text-black",children:t.substring(5)},a);if(t.trim()==="")return e.jsx("br",{},a);if(t.includes("=")&&(t.includes("_")||t.includes("^")||t.includes("∑")||t.includes("∫")))return e.jsx("div",{className:"bg-gray-50 p-3 my-2 rounded border-l-4 border-blue-200 font-mono text-sm",children:t},a);if(t.trim().startsWith("- "))return e.jsx("li",{className:"ml-4 mb-1 text-gray-700",children:t.substring(t.indexOf("- ")+2)},a);if(/^\d+\./.test(t.trim()))return e.jsx("li",{className:"ml-4 mb-1 text-gray-700 list-decimal",children:t.substring(t.indexOf(".")+1).trim()},a);const m=t.replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>");return e.jsx("p",{className:"mb-3 text-gray-700 leading-relaxed",dangerouslySetInnerHTML:{__html:m}},a)});return e.jsx("div",{className:"prose prose-lg max-w-none",children:r(d)})}function O({blogId:d,onBack:r}){const[o,t]=c.useState(!1),[a,m]=c.useState(!1),[l,p]=c.useState(!1);c.useEffect(()=>{const i=setTimeout(()=>t(!0),100);return()=>clearTimeout(i)},[]);const s=[{id:1,title:"Kornai (1979) Framework on Autocratic Governance",excerpt:"A comment on Kornai (1979) where I found similarities between socialist firms and autocratic local governments",date:"2024-02-05",readTime:"6 min read",tags:["Political Economy","Governance","Theory"],featured:!0,content:`## Introduction
...
This would allow LaTeX Workshop to communicate with LaTeX.`}].find(i=>i.id===d);return s?e.jsx("div",{className:"min-h-screen pb-12",children:e.jsxs("div",{className:"max-w-4xl mx-auto px-6",children:[e.jsxs(h.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.6},className:"py-8",children:[e.jsxs(n,{variant:"ghost",onClick:r,className:"mb-8 text-black hover:bg-gray-100",children:[e.jsx(u,{className:"w-4 h-4 mr-2"}),"Back to Blog"]}),e.jsxs("header",{className:"mb-8",children:[e.jsx("h1",{className:"text-black mb-6",style:{fontSize:"var(--academic-font-size-page-title)",fontWeight:"var(--academic-font-weight-page-title)",lineHeight:"var(--academic-line-height-tight)"},children:s.title}),e.jsxs("div",{className:"flex flex-wrap items-center gap-6 mb-6",children:[e.jsxs("div",{className:"flex items-center gap-2 text-gray-600",children:[e.jsx(b,{className:"w-4 h-4"}),e.jsx("span",{style:{fontSize:"var(--academic-font-size-metadata)"},children:new Date(s.date).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})})]}),e.jsxs("div",{className:"flex items-center gap-2 text-gray-600",children:[e.jsx(g,{className:"w-4 h-4"}),e.jsx("span",{style:{fontSize:"var(--academic-font-size-metadata)"},children:s.readTime})]})]}),e.jsx("div",{className:"flex flex-wrap gap-2 mb-8",children:s.tags.map(i=>e.jsx(f,{variant:"secondary",className:"bg-gray-100 text-gray-700 hover:bg-gray-200",children:i},i))})]})]}),e.jsx(h.article,{initial:{opacity:0,y:20},animate:{opacity:o?1:0,y:o?0:20},transition:{duration:.6,delay:.2},className:"prose prose-lg max-w-none",style:{fontSize:"var(--academic-font-size-body)",lineHeight:"var(--academic-line-height-normal)",color:"var(--academic-text-primary)"},children:e.jsx(w,{content:s.content})}),e.jsx(h.div,{initial:{opacity:0,y:20},animate:{opacity:o?1:0,y:o?0:20},transition:{duration:.6,delay:.4},className:"mt-12 pt-8 border-t border-gray-200",children:e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsxs(n,{variant:"outline",size:"sm",onClick:()=>m(!a),className:`${a?"bg-blue-50 text-blue-600 border-blue-200":""}`,children:[e.jsx(y,{className:`w-4 h-4 mr-2 ${a?"fill-current":""}`}),a?"Liked":"Like"]}),e.jsxs(n,{variant:"outline",size:"sm",onClick:()=>p(!l),className:`${l?"bg-yellow-50 text-yellow-600 border-yellow-200":""}`,children:[e.jsx(x,{className:`w-4 h-4 mr-2 ${l?"fill-current":""}`}),l?"Saved":"Save"]})]}),e.jsxs(n,{variant:"outline",size:"sm",children:[e.jsx(v,{className:"w-4 h-4 mr-2"}),"Share"]})]})})]})}):e.jsx("div",{className:"min-h-screen flex items-center justify-center",children:e.jsxs("div",{className:"text-center",children:[e.jsx("h1",{className:"text-2xl font-bold mb-4",children:"Post not found"}),e.jsxs(n,{onClick:r,children:[e.jsx(u,{className:"w-4 h-4 mr-2"}),"Back to Blog"]})]})})}export{O as BlogPostPage};
