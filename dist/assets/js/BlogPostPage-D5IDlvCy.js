...
This would allow LaTeX Workshop to communicate with LaTeX.`}].find(i=>i.id===d);return s?e.jsx("div",{className:"min-h-screen pb-12",children:e.jsxs("div",{className:"max-w-4xl mx-auto px-6",children:[e.jsxs(h.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.6},className:"py-8",children:[e.jsxs(n,{variant:"ghost",onClick:r,className:"mb-8 text-black hover:bg-gray-100",children:[e.jsx(u,{className:"w-4 h-4 mr-2"}),"Back to Blog"]}),e.jsxs("header",{className:"mb-8",children:[e.jsx("h1",{className:"text-black mb-6",style:{fontSize:"var(--academic-font-size-page-title)",fontWeight:"var(--academic-font-weight-page-title)",lineHeight:"var(--academic-line-height-tight)"},children:s.title}),e.jsxs("div",{className:"flex flex-wrap items-center gap-6 mb-6",children:[e.jsxs("div",{className:"flex items-center gap-2 text-gray-600",children:[e.jsx(f,{className:"w-4 h-4"}),e.jsx("span",{style:{fontSize:"var(--academic-font-size-metadata)"},children:new Date(s.date).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})})]}),e.jsxs("div",{className:"flex items-center gap-2 text-gray-600",children:[e.jsx(b,{className:"w-4 h-4"}),e.jsx("span",{style:{fontSize:"var(--academic-font-size-metadata)"},children:s.readTime})]})]}),e.jsx("div",{className:"flex flex-wrap gap-2 mb-8",children:s.tags.map(i=>e.jsx(v,{variant:"secondary",className:"bg-gray-100 text-gray-700 hover:bg-gray-200",children:i},i))})]})]}),e.jsx(h.article,{initial:{opacity:0,y:20},animate:{opacity:o?1:0,y:o?0:20},transition:{duration:.6,delay:.2},className:"prose prose-lg max-w-none",style:{fontSize:"var(--academic-font-size-body)",lineHeight:"var(--academic-line-height-normal)",color:"var(--academic-text-primary)"},children:e.jsx(w,{content:s.content})}),e.jsx(h.div,{initial:{opacity:0,y:20},animate:{opacity:o?1:0,y:o?0:20},transition:{duration:.6,delay:.4},className:"mt-12 pt-8 border-t border-gray-200",children:e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsxs(n,{variant:"outline",size:"sm",onClick:()=>m(!a),className:`${a?"bg-blue-50 text-blue-600 border-blue-200":""}`,children:[e.jsx(g,{className:`w-4 h-4 mr-2 ${a?"fill-current":""}`}),a?"Liked":"Like"]}),e.jsxs(n,{variant:"outline",size:"sm",onClick:()=>p(!l),className:`${l?"bg-yellow-50 text-yellow-600 border-yellow-200":""}`,children:[e.jsx(y,{className:`w-4 h-4 mr-2 ${l?"fill-current":""}`}),l?"Saved":"Save"]})]}),e.jsxs(n,{variant:"outline",size:"sm",children:[e.jsx(x,{className:"w-4 h-4 mr-2"}),"Share"]})]})})]})}):e.jsx("div",{className:"min-h-screen flex items-center justify-center",children:e.jsxs("div",{className:"text-center",children:[e.jsx("h1",{className:"text-2xl font-bold mb-4",children:"Post not found"}),e.jsxs(n,{onClick:r,children:[e.jsx(u,{className:"w-4 h-4 mr-2"}),"Back to Blog"]})]})})}export{C as BlogPostPage};
