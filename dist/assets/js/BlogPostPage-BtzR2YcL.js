import{j as e,r as h,b as f,l as w,C as k,m as y,n as v,o as b}from"./vendor-react--vI7kREJ.js";import{B as r}from"./index-nGMD11s3.js";import{B as _}from"./badge-BfGPAi9u.js";import{P as m}from"./LaTeXRenderer-B-DOGHGS.js";import{m as u}from"./vendor-motion-Bf4tVoKu.js";import"./vendor-misc-CUJeVVI7.js";import"./ui-misc-DW48STyt.js";import"./utils-styling-B2rm_Apj.js";function $({content:p,className:d=""}){const c=g=>{const i=g.split(`
`),o=[];let t=0;for(;t<i.length;){const a=i[t];if(a.trim()===""){t++;continue}if(a.startsWith("#### "))o.push(e.jsx("h4",{className:"text-lg font-medium mt-6 mb-3 text-black",children:e.jsx(m,{children:a.slice(5)})},t));else if(a.startsWith("### "))o.push(e.jsx("h3",{className:"text-xl font-medium mt-8 mb-4 text-black",children:e.jsx(m,{children:a.slice(4)})},t));else if(a.startsWith("## "))o.push(e.jsx("h2",{className:"text-2xl font-medium mt-10 mb-6 text-black",children:e.jsx(m,{children:a.slice(3)})},t));else if(a.startsWith("# "))o.push(e.jsx("h1",{className:"text-3xl font-medium mt-12 mb-8 text-black",children:e.jsx(m,{children:a.slice(2)})},t));else if(a.startsWith("```")){const n=[];for(t++;t<i.length&&!i[t].startsWith("```");)n.push(i[t]),t++;o.push(e.jsx("div",{className:"my-6 bg-gray-900 text-green-400 p-4 rounded-lg font-mono text-sm overflow-x-auto",children:e.jsx("pre",{children:n.join(`
`)})},t))}else if(a.trim()==="---")o.push(e.jsx("hr",{className:"my-8 border-gray-300"},t));else if(a.match(/^\d+\.\s/)){const n=[];for(;t<i.length&&i[t].match(/^\d+\.\s/);)n.push(i[t].replace(/^\d+\.\s/,"")),t++;t--,o.push(e.jsx("ol",{className:"list-decimal list-inside my-4 space-y-2 text-black",children:n.map((s,l)=>e.jsx("li",{children:e.jsx(m,{children:s})},l))},t))}else if(a.startsWith("- ")||a.startsWith("* ")){const n=[];for(;t<i.length&&(i[t].startsWith("- ")||i[t].startsWith("* "));)n.push(i[t].slice(2)),t++;t--,o.push(e.jsx("ul",{className:"list-disc list-inside my-4 space-y-2 text-black",children:n.map((s,l)=>e.jsx("li",{children:e.jsx(m,{children:s})},l))},t))}else if(a.startsWith("> ")){const n=[];for(;t<i.length&&i[t].startsWith("> ");)n.push(i[t].slice(2)),t++;t--,o.push(e.jsx("blockquote",{className:"border-l-4 border-[#b8a9ff] pl-4 my-6 italic text-gray-700",children:e.jsx(m,{children:n.join(" ")})},t))}else{const n=[a];for(t++;t<i.length&&i[t].trim()!==""&&!i[t].startsWith("#")&&!i[t].startsWith("- ")&&!i[t].startsWith("* ")&&!i[t].match(/^\d+\./)&&!i[t].startsWith("```")&&!i[t].startsWith("> ")&&i[t].trim()!=="---";)n.push(i[t]),t++;t--;const s=n.join(" ");o.push(e.jsx("p",{className:"my-4 text-black leading-relaxed",children:e.jsx(m,{children:s})},t))}t++}return o};return e.jsx("div",{className:`markdown-content ${d}`,children:c(p)})}function I({blogId:p,onBack:d}){const[c,g]=h.useState(!1),[i,o]=h.useState(!1),[t,a]=h.useState(!1);h.useEffect(()=>{const l=setTimeout(()=>g(!0),100);return()=>clearTimeout(l)},[]);const s=[{id:1,title:"Understanding DSGE Models in Modern Economics",excerpt:"A deep dive into Dynamic Stochastic General Equilibrium models and their practical applications in policy analysis.",date:"2024-02-15",readTime:"8 min read",tags:["Macroeconomics","DSGE","Policy"],featured:!0,content:`Dynamic Stochastic General Equilibrium (DSGE) models have become the workhorse of modern macroeconomic analysis. These models provide a comprehensive framework for understanding how economies respond to various shocks and policy interventions.
...
*What are your thoughts on DSGE models? Have you worked with these frameworks in your research? I'd love to hear about your experiences in the comments below.*`},{id:2,title:"The Mathematics Behind Stochastic Growth Theory",excerpt:"Exploring the mathematical foundations that make stochastic growth models so powerful for economic forecasting.",date:"2024-01-28",readTime:"12 min read",tags:["Mathematics","Growth Theory","Modeling"],content:`Stochastic growth theory represents one of the most elegant applications of mathematical analysis to economic problems. By incorporating random shocks into growth models, we can better understand the sources of economic fluctuations and long-term development patterns.
...
*Have you worked with stochastic growth models? What computational challenges have you encountered? Share your experiences in the comments!*`},{id:3,title:"New Keynesian Framework: A Computational Approach",excerpt:"How computational methods are revolutionizing our understanding of New Keynesian economic models.",date:"2024-01-10",readTime:"10 min read",tags:["New Keynesian","Computation","Monetary Policy"],content:`The New Keynesian framework has evolved significantly with advances in computational methods. Modern techniques allow us to solve and estimate these models with unprecedented precision and scope, opening new avenues for both theoretical understanding and practical policy analysis.
...
*What computational challenges have you encountered in macroeconomic modeling? Which methods have you found most effective? Share your thoughts below!*`},{id:4,title:"Teaching Economics Through Interactive Models",excerpt:"Innovative approaches to making complex economic concepts accessible to undergraduate students.",date:"2023-12-22",readTime:"6 min read",tags:["Teaching","Education","Interactive Models"],content:`Teaching complex economic models to undergraduate students presents unique challenges. Traditional approaches often rely on static presentations and abstract mathematical formulations that can seem disconnected from real-world phenomena. Interactive models and visual demonstrations offer a powerful alternative that can transform abstract concepts into intuitive understanding.
...
*What has been your experience with interactive learning in economics? Have you found certain types of simulations particularly effective? I'd love to hear your thoughts and experiences in the comments below.*`},{id:5,title:"The Future of Macroeconomic Modeling",excerpt:"Emerging trends and technologies that will shape the next generation of economic models.",date:"2023-12-08",readTime:"9 min read",tags:["Future","Technology","Modeling"],content:`The landscape of macroeconomic modeling is undergoing a fundamental transformation. Driven by exponential advances in computing power, revolutionary developments in artificial intelligence, and unprecedented access to real-time data, the next generation of economic models promises to be more accurate, more comprehensive, and more relevant to policy-making than ever before.
...
*What aspects of future macroeconomic modeling do you find most promising or concerning? How do you think the field should balance innovation with caution? Share your thoughts on the future of economic modeling in the comments below.*`}].find(l=>l.id===p);return s?e.jsx(u.div,{className:"min-h-screen pb-12 px-6",initial:c?!1:{opacity:0,y:10},animate:c?!1:{opacity:1,y:0},transition:{duration:.3,ease:[.22,1,.36,1]},style:{willChange:c?"auto":"transform, opacity"},children:e.jsxs("div",{className:"max-w-4xl mx-auto",children:[e.jsxs(u.div,{initial:c?!1:{opacity:0,y:20},animate:c?!1:{opacity:1,y:0},transition:{duration:c?0:.4,ease:[.22,1,.36,1]},className:"mb-8",children:[e.jsxs(r,{onClick:d,variant:"ghost",className:"mb-6 text-black hover:text-[#6A5ACD]",children:[e.jsx(f,{className:"w-4 h-4 mr-2"}),"Back to Blog"]}),e.jsxs("div",{className:"mb-6",children:[e.jsx("h1",{className:"text-4xl text-black mb-4 leading-tight",children:s.title}),e.jsxs("div",{className:"flex items-center justify-between mb-4",children:[e.jsxs("div",{className:"flex items-center space-x-4 text-black",children:[e.jsxs("div",{className:"flex items-center space-x-1",children:[e.jsx(w,{className:"w-4 h-4"}),e.jsx("span",{children:new Date(s.date).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})})]}),e.jsxs("div",{className:"flex items-center space-x-1",children:[e.jsx(k,{className:"w-4 h-4"}),e.jsx("span",{children:s.readTime})]})]}),e.jsxs("div",{className:"flex items-center space-x-2",children:[e.jsx(r,{variant:"ghost",size:"sm",onClick:()=>o(!i),className:`text-black hover:text-[#6A5ACD] ${i?"text-red-600":""}`,children:e.jsx(y,{className:`w-4 h-4 ${i?"fill-current":""}`})}),e.jsx(r,{variant:"ghost",size:"sm",onClick:()=>a(!t),className:`text-black hover:text-[#6A5ACD] ${t?"text-yellow-600":""}`,children:e.jsx(v,{className:`w-4 h-4 ${t?"fill-current":""}`})}),e.jsx(r,{variant:"ghost",size:"sm",className:"text-black hover:text-[#6A5ACD]",children:e.jsx(b,{className:"w-4 h-4"})})]})]}),e.jsx("div",{className:"flex flex-wrap gap-2 mb-6",children:s.tags.map((l,x)=>e.jsx(_,{variant:"outline",className:"bg-[#f3f1ff] text-[#6A5ACD] border-[#d6ceff]",children:l},x))}),e.jsx("p",{className:"text-xl text-black leading-relaxed italic border-l-4 border-[#b8a9ff] pl-6",children:s.excerpt})]})]}),e.jsx(u.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.4,delay:.2},className:"prose prose-lg max-w-none mb-12",children:e.jsx("div",{className:"p-8 border border-[#e9e5ff] rounded-lg bg-white/50",children:e.jsx("div",{className:"text-black leading-relaxed whitespace-pre-line",style:{lineHeight:"1.7"},children:e.jsx($,{content:s.content,className:""})})})}),e.jsxs(u.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.4,delay:.4},className:"border-t border-[#d6ceff] pt-8",children:[e.jsx("div",{className:"flex items-center justify-between mb-8",children:e.jsxs("div",{className:"flex items-center space-x-4",children:[e.jsxs(r,{onClick:()=>o(!i),variant:i?"default":"outline",className:i?"bg-red-600 hover:bg-red-700 text-white":"border-red-300 text-red-600 hover:bg-red-50",children:[e.jsx(y,{className:"w-4 h-4 mr-2"}),i?"Liked":"Like"]}),e.jsxs(r,{onClick:()=>a(!t),variant:t?"default":"outline",className:t?"bg-yellow-600 hover:bg-yellow-700 text-white":"border-yellow-300 text-yellow-600 hover:bg-yellow-50",children:[e.jsx(v,{className:"w-4 h-4 mr-2"}),t?"Bookmarked":"Bookmark"]}),e.jsxs(r,{variant:"outline",className:"border-[#b8a9ff] text-[#6A5ACD] hover:bg-[#f3f1ff]",children:[e.jsx(b,{className:"w-4 h-4 mr-2"}),"Share"]})]})}),e.jsxs("div",{className:"flex justify-between items-center",children:[e.jsxs(r,{onClick:d,variant:"outline",className:"border-[#b8a9ff] text-[#6A5ACD] hover:bg-[#f3f1ff]",children:[e.jsx(f,{className:"w-4 h-4 mr-2"}),"Back to Blog"]}),e.jsxs("div",{className:"flex space-x-2",children:[e.jsx(r,{className:"bg-[#6A5ACD] hover:bg-[#5a4fcf] text-white",children:"Previous Post"}),e.jsx(r,{className:"bg-[#6A5ACD] hover:bg-[#5a4fcf] text-white",children:"Next Post"})]})]})]})]})}):e.jsx(u.div,{className:"min-h-screen pb-12 px-6 flex items-center justify-center",children:e.jsxs("div",{className:"text-center",children:[e.jsx("h1",{className:"text-2xl text-black mb-4",children:"Post Not Found"}),e.jsxs(r,{onClick:d,className:"bg-[#6A5ACD] hover:bg-[#5a4fcf] text-white",children:[e.jsx(f,{className:"w-4 h-4 mr-2"}),"Back to Blog"]})]})})}export{I as BlogPostPage};
